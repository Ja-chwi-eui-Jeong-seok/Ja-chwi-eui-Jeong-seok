...
class _SplashPageState extends State<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  final userProfileDoc = await firestore.collection('user_profile').doc(uid).get();
